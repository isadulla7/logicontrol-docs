...
| Qolganlari (`BK-14` operator autentifikatsiyasi — email+parol + RBAC (OPEN-018); `OPEN-009` web moslash; AN: `AUTH_RATE_LIMITED` matni; faza-gate jonli integratsiyalar B1–B4; SMS yetkazish integratsiyasi) | Boshlanmagan |
