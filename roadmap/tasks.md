...
| Egasining qarorlari (2026-08-26) | ✅ Barcha ochiq savollar yopildi — OPEN-001..013 `decisions.md` §Yopilgan da qiymatlari bilan; `DC-01` (ADR-002) va `DC-02` (ADR-003) endi shu qarorlar asosida mexanik yoziladi, dizayn hujjatlari qiymatlar bilan yangilangan |
