...
([FAKT: OPEN-015 yopilgan] tizim lug'ati, server e'lon qiladi, **majburiy**), **reys** (T2 dan
avtomatik; FAB dan: tanlash yoki «umumiy» [FAKT: `domain/model.md` — reysga bog'liq yoki
umumiy]), **izoh** (ixtiyoriy; [FAKT: OPEN-014 yopilgan] MVP da chekning yagona izi — shu matn,
shuning uchun maydon ko'zga tashlanadigan joyda va placeholder chek rekvizitlarini eslatadi).
Chek foto maydoni yo'q [FAKT: `FileAsset` MVP dan tashqari; OPEN-014 bo'yicha keyingi bosqich].
