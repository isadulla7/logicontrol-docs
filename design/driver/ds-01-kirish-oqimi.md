...
- [FAKT: `adr/ADR-002-driver-authentication.md` + `decisions.md` OPEN-010] Qiymatlar:
  aktivatsiya kodi **6 raqam / 15 daqiqa / SMS + operator og'zaki**, qayta yuborish 60 soniyadan
  keyin; PIN **4 raqam** (5 noto'g'ri urinish → 30 s pauza, ikki baravar o'sadi); server
  rate-limit **5 urinish → 15 daqiqa** (kod so'rovlari soatiga 3, kuniga 10); sessiya **30 kun,
  refresh'da token to'liq aylanadi** — offline chidamlilik (grace-oyna) shu tokenning 30 kunlik
  amal muddati bilan bir xil; **1 faol qurilma**.
...
- [FAKT: `decisions.md` OPEN-011 yopilgan] MVP da bir haydovchi — bitta faol a'zolik; kompaniya
...
- [FAKT: OPEN-011 yopilgan] **A3 MVP da render qilinmaydi** — bir haydovchi bitta faol a'zolik,
...
qoidasini ishga soladi. [FAKT: OPEN-012 yopilgan, egasining qarori] Umumiy qurilma stsenariysi (bitta
...
5. Qayta tasdiqlash: operator yangi aktivatsiya kodi beradi (SMS yoki og'zaki) — o'z-o'ziga
   xizmat reset yo'q.
6. Sessiya: 30 kun, refresh'da token to'liq aylanadi (ADR-002; egasining tie-break qarori —
   90-kun varianti bekor). Grace-oyna alohida mexanizm emas: tokenning 30 kunlik amal muddati.
7. Qurilmalar: 1 faol qurilma; yangi aktivatsiya eskisini bekor qiladi (eski qurilmaning
   yuborilmagan navbati server tomonidan baribir qabul qilinadi — OPEN-012 qoidasi); operator
