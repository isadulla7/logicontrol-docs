...
| `EMPTY` | Foydalanuvchida kompaniya yo'q: «Kompaniya yaratish» oqimiga taklif (STIR autofill bilan, [FAKT: OPEN-019 yopilgan]); a'zoligi to'xtatilgan foydalanuvchiga esa «kim bilan bog'lanish» ko'rsatiladi. |
...
([FAKT: OPEN-015 yopilgan] tizim lug'ati — filtrlashga barqaror asos), reys, kiritilgan vaqt,
...
kerak; [FAKT: OPEN-016 yopilgan] FX «tranzaksiya vaqti» — haydovchi kiritgan lahza, server
...
o'zbek + rus (OPEN-003); FX «tranzaksiya vaqti» — haydovchi kiritgan lahza (OPEN-016); vaqt —
kompaniya mintaqasi, standart Asia/Tashkent (OPEN-004); operator kirishi — email + parol,
2FA keyinroq (OPEN-018); onboarding — konsol ichida birinchi kirishda, STIR autofill bilan
(OPEN-019). Operator kirish ekrani va onboarding oqimining batafsil dizayni WB-01
