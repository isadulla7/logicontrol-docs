...
> **Bog'liqlik eslatmasi.** [FAKT: `roadmap/tasks.md`] DS-03 `DC-03` (API kontrakti) ga bog'liq;
> kontrakt hali yozilmagan. Server javob shakllari haqidagi har faraz [TAXMIN] bilan belgilangan
> va `DC-03` ni yozadigan sessiya bu hujjatdagi [TAXMIN] ro'yxatini kontraktga kirish sifatida
> ishlatishi mo'ljallangan.
